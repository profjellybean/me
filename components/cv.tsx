...
const bio = [
    {
        ...
        description2: "I am actively engaged in both academic studies and professional development as a full-stack developer at the very same university. In addition to my expertise in software development, I am an enthusiastic musician and an avid climber, seeking inspiration from diverse disciplines to fuel my creativity.",
    }
];
